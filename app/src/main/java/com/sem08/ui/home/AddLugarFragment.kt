...
import com.sem08.ui.utilidades.AudioUtiles
import com.sem08.ui.utilidades.ImagenUtiles
...
class AddLugarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //Audio
        audioUtiles = AudioUtiles(requireActivity(),requireContext(),
            binding.btAccion, binding.btPlay, binding.btDelete, getString(R.string.msgIniciaNotaAudio)
            ,getString(R.string.msgDetieneNotaAudio))
